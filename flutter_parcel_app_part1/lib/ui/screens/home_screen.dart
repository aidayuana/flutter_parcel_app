...
import 'package:flutter_parcel_app/widgets/my_bottom_navigation_bar.dart';
            ...
            actions: [
              Padding(
                ...
                child: CircleAvatar(
                  child: ClipOval(
                    child: Image.network(
                        'https://assets.pikiran-rakyat.com/crop/0x0:0x0/x/photo/2021/07/29/2072340695.jpeg'),
                  ),
                ),
              ),
            ],
